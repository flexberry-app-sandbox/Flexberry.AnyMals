...
namespace IIS.AnyMals
{
    ...
    public class Burrow : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.AnyMals.Forest fForest;
        
        private IIS.AnyMals.Animal fAnimal;
        ...
        [PropertyStorage(new string[] {
                "Forest"})]
        [NotNull()]
        public virtual IIS.AnyMals.Forest Forest
        {
            get
            {
                ...
                IIS.AnyMals.Forest result = this.fForest;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.AnyMals.Animal.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "Animal"})]
        public virtual IIS.AnyMals.Animal Animal
        {
            get
            {
                ...
                IIS.AnyMals.Animal result = this.fAnimal;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View BurrowE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("BurrowE", typeof(IIS.AnyMals.Burrow));
                }
            }
        }
    }
    ...
    public class DetailArrayOfBurrow : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.AnyMals.DetailArrayOfBurrow members)

        // *** End programmer edit section *** (IIS.AnyMals.DetailArrayOfBurrow members)
        ...
        /// </summary>
        public DetailArrayOfBurrow(IIS.AnyMals.Animal fAnimal) : 
                base(typeof(Burrow), ((ICSSoft.STORMNET.DataObject)(fAnimal)))
        {
        }
        
        public IIS.AnyMals.Burrow this[int index]
        {
            get
            {
                return ((IIS.AnyMals.Burrow)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.AnyMals.Burrow dataobject)
        {
